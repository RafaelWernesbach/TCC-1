...
\titulo{Desenvolvimento de um Sistema Educacional Integrado para a Escola da Magistratura do Estado do Espirito Santo}
...
\palavraschave{Sistemas de informação educacional, gestão educacional, automação de processos acadêmicos, sistemas integrados, modernização de instituições de ensino.}
