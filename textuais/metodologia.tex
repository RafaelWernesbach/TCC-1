...
existente, em funcionamento e integrada a diferentes rotinas
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.95\textwidth]{imagens/erd-conceitual-geral-fluxo-pedagogico.png}
    \caption{Diagrama conceitual entre as entidades principais}
    \label{fig:erd-geral-fluxo-pedagogico-conceitual}
\end{figure}

\begin{figure}[H]
    \centering
    % \includegraphics[width=0.95\textwidth]{imagens/erd-logico-geral-fluxo-pedagogico.png}
    \caption{Diagrama lógico entre as entidades principais}
    \label{fig:erd-geral-fluxo-pedagogico-logico}
\end{figure}
...
\begin{figure}[htbp]
\centering
\caption{Fluxo conceitual dos dados no ciclo pedagógico - colocar um diagrama de estados ou bpmn talvez}
\label{fig:fluxo-dados-pedagogico}
  \fbox{
    %  \includegraphics[scale=1.0]{imagens/fluxo-pedagogico-educa-emes.svg}
  }
  \legend{Legenda}
\end{figure}
