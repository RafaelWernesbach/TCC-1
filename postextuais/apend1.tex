...
\section{ERD completo das entidades relacionadas ao fluxo pedagógico}
\label{apend:diagramas-analise-sistema:erd-pedagogico}

Apresenta o modelo de dados completo das entidades relacionadas ao fluxo pedagógico,
incluindo as principais tabelas, seus campos e os relacionamentos
entre elas.

\begin{center}
\includegraphics[width=\textwidth,height=3.42\textheight,keepaspectratio]{imagens/erd-completo.png}
\end{center}

% \noindent\textbf{Arquivo-fonte:} \texttt{imagens/erd-completo.svg}
...
\begin{center}
\includegraphics[width=\textwidth,height=3.42\textheight,keepaspectratio]{imagens/modelo-conceitual.png}
\end{center}
